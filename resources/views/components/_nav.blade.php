    ...
    <div id="header">
        <div class="container">
            ...
            <div class="left-side">
                ...
                <!-- Logo -->
                <div id="logo">
                    <a href="/properties"><img src="{{ asset('images/logo.png') }}" alt=""></a>
                </div>
                    ...
                    <ul id="responsive">
                        ...
                        <li><a class="current" href="#">Home</a>
                            <ul>
                                ...
                                <li><a href="index-3.html">Homere 3</a></li>
            ...
            <div class="right-side">
                ...
                @auth('admin')
                    <div class="user-menu">
                        <div class="user-name"><span></span>Hi, {{ Auth::guard('admin')->user()->name }}!</div>
                        <ul>
                            <li>
