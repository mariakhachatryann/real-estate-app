    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <!-- Image Box -->
                <a href="listings-list-with-sidebar.html" class="img-box" style="background-image: url('images/popular-location-01.jpg'); background-size: cover;">
            ...
            <div class="col-md-8">
                ...
                <!-- Image Box -->
                <a href="listings-list-with-sidebar.html" class="img-box" style="background-image: url('images/popular-location-02.jpg'); background-size: cover;">
                    <div class="img-box-content visible">
                        <h4>Los Angeles</h4>
            ...
            <div class="col-md-8">
                ...
                <!-- Image Box -->
                <a href="listings-list-with-sidebar.html" class="img-box" style="background-image: url('images/popular-location-03.jpg'); background-size: cover;">
                    <div class="img-box-content visible">
                        <h4>San Francisco </h4>
            ...
            <div class="col-md-4">
                ...
                <!-- Image Box -->
                <a href="listings-list-with-sidebar.html" class="img-box" style="background-image: url('images/popular-location-04.jpg'); background-size: cover;">
                    <div class="img-box-content visible">
                        <h4>Miami</h4>
